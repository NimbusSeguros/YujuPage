...
<img className="imgBannerMotosCelular" src="https://res.cloudinary.com/dewcgbpvp/image/upload/v1732294859/Banner-contacto-celular_rge8dd.svg" alt="" />
    ...
    <h2 className="h2Banner">Navegá con confianza. <span className="spanBanner"> 
    Yuju te asesora para que elijas el seguro     <br/>
    ideal para tu embarcación.
    Trabajamos con las mejores 
    <br/>
    aseguradoras. ¿Querés navegar seguro? </span>
   </h2>
